    ...
    if(isset($_POST['btn-add-customer']))
    {
        ...
        !empty($address)  && !empty($dob))
        {
            ...
            if($addcustomer['status'])
            {
                ...
                redirect('../../MainUI/AdminUI/customers.php', '', "You've added customer successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/AdminUI/add_customers.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/AdminUI/add_customers.php', 'All fields are required.', '');
            exit(0);                            
        }
    }
?>