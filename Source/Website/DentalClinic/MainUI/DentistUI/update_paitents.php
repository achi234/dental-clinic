...
<body>
    ...
    <div class="main-content">
        <div class="content">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-column" scope="col">
                                            ...
                                            <a href="../../Controller/DentistController/delete_toothproblem.php?id=<?php echo $paitent['data']['ID_Customer'];?>&Description=<?php echo $tooth_problem['Descript'];?>" 
                            ...
                            <table class="table">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-column" scope="col">
                                            <div class="text-column__action">
                                            <a href="../../Controller/DentistController/delete_contraindication.php?id=<?php echo $paitent['data']['ID_Customer'];?>&medicine=<?php echo $contraindication['ID_Medicine'];?>" 
                                            class="btn-control btn-control-delete">
                                                <i class="fa-solid fa-trash-can btn-control-icon"></i>
                                                Delete
                                            </a>
            ...
            <div class="container">
                <div class="container-recent">
                <!-- <form method="POST" action="../../Controller/DentistController/add_toothproblem.php"> -->
                    <div class="container-recent-inner">
                        <div class="container-recent__heading">
