<?php
    ...
    if(isset($_POST['btn-updateAppt']))
    {
        ...
        else
        {
            ...
            {
                redirect('../../MainUI/AdminUI/update_appointments.php?id='.$appointment_id, 'Cannot find customer <' .$appt_customerName. '>.Please try again', '');
                exit(0);
            }
            ...
            {
                redirect('../../MainUI/AdminUI/appointments.php', '', "You've modified appointment successfully!");
            }
            else
            {
                redirect('../../MainUI/AdminUI/update_appointments.php?id='.$appointment_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>