<?php
    ...
    if(isset($_POST['btn-updatePaitent']))
    {
        ...
        {
            redirect('../../MainUI/StaffUI/update_paitents.php?id='.$patient_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
                //echo "Here";
               redirect('../../MainUI/StaffUI/update_paitents.php?id='.$patient_id, '', "You've modified patient successfully!");
            }
            else
            {
               redirect('../../MainUI/StaffUI/update_paitents.php?id='.$patient_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>