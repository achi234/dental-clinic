    ...
    if(isset($_POST['btn-add-select']))
    {
        ...
        !empty($datetime) && !empty($returndays))
        {
            ...
            if($addPlan['status'])
            {
                ...
                redirect('../../MainUI/DentistUI/update_paitents.php?id='.$paitent_id, '', "You've added treatment plan successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/DentistUI/add_treatmentplans.php?id='.$paitent_id, 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/DentistUI/add_treatmentplans.php?id='.$paitent_id, 'All fields are required.', '');
            exit(0);                            
        }
    }
?>