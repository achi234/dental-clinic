                ...
                <div class="container-recent">
                    <div class="card shadow">
                        ...
                        <div class="container-recent__body card__body-form">
                            <form method="POST" action="../../Controller/DentistController/update_prescribe.php">
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        ...
                                        <div class="form-col">
                                            ...
                                            <input type="text" name="medicine_name" class="form-control" class="form-cotrol" value="<?php echo $medicine_name?>" readonly>
                                        </div>
