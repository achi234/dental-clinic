                ...
                <div class="container-recent">
                    <div class="card shadow">
                        ...
                        <div class="container-recent__body card__body-form">
                            <form method="POST" action="../../Controller/DentistController/add_patient.php">
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        ...
                                        <div class="form-col">
                                            ...
                                            <input type="text" name="dentist_phone" value="<?php echo $dentist_phone;?>" class="form-control" readonly>
