    ...
    if(isset($_POST['btn-add-appt']))
    {
        ...
        if(!empty($dentist) && !empty($patient) &&!empty($date) && !empty($time))
        {
            ...
            if($addAppt['status'])
            {
                ...
                redirect('../../MainUI/CustomerUI/appointments.php', '', "You've added appointment successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/CustomerUI/add_appointments.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
