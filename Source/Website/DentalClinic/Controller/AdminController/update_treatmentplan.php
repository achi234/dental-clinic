<?php
    ...
    if(isset($_POST['btn-updatePlan']))
    {
        ...
        {
            redirect('../../MainUI/AdminUI/update_treatmentplans.php?id='.$select_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
                redirect('../../MainUI/AdminUI/update_appointments.php?id='.$select_id, 'Cannot find customer <' .$select_customerName. '>.Please try again', '');
                exit(0);
            }
            ...
            {
                redirect('../../MainUI/AdminUI/update_treatmentplans.php?id='.$select_id, '', "You've modified plan successfully!");
            }
            else
            {
                redirect('../../MainUI/AdminUI/update_treatmentplans.php?id='.$select_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>