    ...
    if(isset($_POST['btn-add-patient']))
    {
        ...
        && !empty($ngaytaohoso) && !empty($id_dichvu))
        {
            ...
            if($addpatient['status'])
            {
                ...
                redirect('../../MainUI/DentistUI/patients.php', '', "You've added patient's profile successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/DentistUI/add_patients.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/DentistUI/add_patients.php', 'All fields are required.', '');
            exit(0);                            
        }
    }
?>