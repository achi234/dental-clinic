<?php
    ...
    if(isset($_POST['btn-updateAppt']))
    {
        ...
        {
            redirect('../../MainUI/StaffUI/update_appointments.php?id='.$appointment_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
                redirect('../../MainUI/StaffUI/update_appointments.php?id='.$appointment_id, 'Cannot find customer <' .$appt_customerName. '>.Please try again', '');
                exit(0);
            }
            ...
            {
                redirect('../../MainUI/StaffUI/appointments.php', '', "You've modified appointment successfully!");
            }
            else
            {
                redirect('../../MainUI/StaffUI/update_appointments.php?id='.$appointment_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>