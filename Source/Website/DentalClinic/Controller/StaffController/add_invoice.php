    ...
    if(isset($_POST['btn-add-invoice']))
    {
        ...
        if(!empty($select_id) && !empty($payment_id) && !empty($amount_paid))        {
            ...
            if($addInvoice['status'])
            {
                ...
                redirect('../../MainUI/StaffUI/invoices.php', '', "You've added invoice successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/StaffUI/add_invoices.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/StaffUI/add_invoices.php', 'All fields are required.', '');
            exit(0);                            
        }
    }
?>