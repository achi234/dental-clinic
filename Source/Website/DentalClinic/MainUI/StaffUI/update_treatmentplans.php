                ...
                <div class="container-recent">
                    <div class="card shadow">
                        ...
                        <div class="container-recent__body card__body-form">
                            <form method="POST" action="../../Controller/StaffController/update_treatmentplan.php">
                                <div class="form-row">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-column" scope="row">
                                            <div class="text-column__action">
                                                <a href="../../Controller/StaffController/delete_chooseTooth.php?id=<?php echo $choose_tooth['ID_Select'];?>&tooth_id=<?php echo $choose_tooth['ID_Tooth'];?>&surface_id=<?php echo $choose_tooth['ID_Surface'];?>" 
                            ...
                            <table class="table">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-column" scope="row">
                                            <div class="text-column__action">
                                            <a href="../../Controller/StaffController/delete_chooseTreatment.php?id=<?php echo $choose_treatment['ID_Select'];?>&treatment_id=<?php echo $choose_treatment['ID_Treatment'];?>" 
                                                class="btn-control btn-control-delete">
                                                    <i class="fa-solid fa-trash-can btn-control-icon"></i>
                                                    Delete
                                                </a>
