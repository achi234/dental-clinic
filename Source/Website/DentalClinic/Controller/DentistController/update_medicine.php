<?php
    ...
    if(isset($_POST['btn-updateMedicine']))
    {
        ...
        {
            redirect('../../MainUI/DentistUI/update_medicines.php?id='.$medicine_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
                redirect('./../MainUI/DentistUI/update_patients.php?id='.$patient_id, '', "You've modified medicine successfully!");
            }
            else
            {
                redirect('./../MainUI/DentistUI/update_patients.php?id='.$patient_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>