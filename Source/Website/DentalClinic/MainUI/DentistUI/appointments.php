...
$appointments = getbyKeyValueWithPagination('CUOCHEN', $pageSize, $pageNumber, 'ID_CuocHen', 'SDT_NS', $dentist_phone);
?>
                                        ...
                                        */?> 
                                        <th class="text-column" scope="row">
                                            <div class="text-column__action">
                                                <a href="../../Controller/DentistController/delete_appointment.php?id=<?php  echo $appointment['ID_CuocHen']?>" 
