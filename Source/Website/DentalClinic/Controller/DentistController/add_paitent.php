    ...
    if(isset($_POST['btn-add-paitent']))
    {
        ...
        !empty($address)  && !empty($dob))
        {
            ...
            if($addPaitent['status'])
            {
                ...
                redirect('../../MainUI/DentistUI/paitents.php', '', "You've added customer successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/DentistUI/add_paitents.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/DentistUI/add_paitents.php', 'All fields are required.', '');
            exit(0);                            
        }
    }
?>