    ...
    if(isset($_POST['btn-add-appt']))
    {
        ...
        if(!empty($date) && !empty($time))
        {
            ...
            if($addAppt['status'])
            {
                ...
                redirect('../../MainUI/StaffUI/appointments.php', '', "You've added appointment successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/StaffUI/add_appointments.php', 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/StaffUI/add_appointments.php', 'All fields are required.', '');
            exit(0);                            
        }
    }
?>