    ...
    if(isset($_POST['btn-add-choosetreatment']))
    {
        ...
        !empty($choosetreatment_price))
        {
            ...
            if($addCT['status'])
            {
                ...
                redirect('../../MainUI/DentistUI/update_treatmentplans.php?id='.$select_id, '', "You've added choose treatment successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/DentistUI/add_choosetreatments.php?id='.$select_id, 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/DentistUI/add_choosetreatments.php?id='.$select_id, 'All fields are required.', '');
            exit(0);                            
        }
    }
?>