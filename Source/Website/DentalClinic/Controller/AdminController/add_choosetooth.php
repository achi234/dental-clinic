    ...
    if(isset($_POST['btn-add-choosetooth']))
    {
        ...
        !empty($surface_id) && !empty($choosetooth_price))
        {
            ...
            if($addCT['status'])
            {
                ...
                redirect('../../MainUI/AdminUI/update_treatmentplans.php?id='.$select_id, '', "You've added choose tooth successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/AdminUI/add_choosetooths.php?id='.$select_id, 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/AdminUI/add_choosetooths.php?id='.$select_id, 'All fields are required.', '');
            exit(0);                            
        }
    }
?>