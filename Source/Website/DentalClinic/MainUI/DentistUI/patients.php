<?php
    ...
    $dentist_phone = $_SESSION['sdt']['sdt'];
    $patients = getbyKeyValueWithPagination('HOSOKHACHHANG', $pageSize, $pageNumber, 'ID_HoSo', 'SDT_NS', $dentist_phone);
?>
                            ...
                            <?php
                                ...
                                if(isset($_POST["btn-search"]))
                                {
                                    ...
                                    if($patients['status'] == 'No Data Found')
                                    {
                                        ...
                                        $patients = getbyKeyValueWithPagination('HOSOKHACHHANG', $pageSize, $pageNumber, 'ID_HoSo', 'SDT_NS', $_SESSION['sdt']['sdt']);
                                    }
                                }
                                else
                                {
