<?php
    ...
    if(isset($_POST['btn-updatePatient']))
    {
        ...
        {
            redirect('../../MainUI/DentistUI/update_patients.php?id='.$patient_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
                //echo "Here";
               redirect('../../MainUI/DentistUI/patients.php?id='.$patient_id, '', "You've modified patient successfully!");
            }
            else
            {
