    ...
    if(isset($_POST['btn-updatePrescribe']))
    {
         ...
         !empty($quantity))
        {
            ...
            if($result)
            {
                ...
                redirect('../../MainUI/DentistUI/update_patients.php?id='.$select_id, '', "You've updated prescribe successfully!");
            }
            else
            {
                echo "Something went wrong! Please enter again...";
                redirect('../../MainUI/DentistUI/update_patients.php?id='.$select_id, 'Something went wrong! Please enter again...', "");
            }                            
        }
        else
        {
            echo "All fields are required.";
            redirect('../../MainUI/DentistUI/update_prescribes.php?id='.$medicine_id.'&record_id='.$select_id, 'All fields are required.', '');
            exit(0);                            
        }
    }
?>